...
static fbInfoElement_t yaf_tch_info_elements[] = {
     ...
     FB_IE_INIT("tcpSequenceJumpCount", TCH_PEN, 1036, 8, FB_IE_F_ENDIAN | FB_IE_F_REVERSIBLE),
     FB_IE_INIT("tcpLossEventCount", TCH_PEN, 1038, 8, FB_IE_F_ENDIAN | FB_IE_F_REVERSIBLE),
     ...
     FB_IE_INIT("lastSynTcpFlags", TCH_PEN, 1053, 2, FB_IE_F_ENDIAN | FB_IE_F_REVERSIBLE),
     FB_IE_NULL
};
